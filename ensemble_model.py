...
def visualize_model_comparison(results, ensemble_results, y_test):
    ...
    save_dataframe(comparison_df, 'model_comparison.csv', index=False)
    ...
    plt.tight_layout()
    save_plot('ensemble_comparison.png')
    plt.close()
    ...
    # Save the figure
    plt.tight_layout()
    save_plot('ensemble_roc_curves.png')
    plt.close()
    ...
    plt.tight_layout()
    save_plot('ensemble_confusion_matrices.png')
    plt.close()
